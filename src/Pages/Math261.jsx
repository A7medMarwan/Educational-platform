...
const pdfFiles = [
  ...
  { name: "بطاقة علاجية تفاعلية عن الاحداث المتنافية والغير متنافية 1.pdf", display: "بطاقة علاجية: الأحداث المتنافية وغير المتنافية" },
...
export default function Math261() {
  ...
  const getPublicUrl = (fileName) => {
    return supabase.storage.from('uploads').getPublicUrl(`math261/${fileName}`).data.publicUrl;
  };
  ...
  return (
    <div style={{ background: "var(--secondary)", paddingBlock: "20px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "2rem 1rem" }}>
        ...
        <FileUpload folderName="math261" onFilesAdded={handleUpload} />
        <input
          type="text"
